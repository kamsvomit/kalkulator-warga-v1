              ...
              <svg id="sun-icon" class="w-4 h-4 hidden" fill="none" stroke="url(#sunGrad)" viewBox="0 0 24 24">
                <defs>
                  <linearGradient id="sunGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stop-color="#ef4444"><animate attributeName="stop-color" values="#ef4444;#f97316;#ef4444" dur="4s" repeatCount="indefinite"/></stop>
                    <stop offset="100%" stop-color="#f97316"><animate attributeName="stop-color" values="#f97316;#dc2626;#f97316" dur="4s" repeatCount="indefinite"/></stop>
                  </linearGradient>
                </defs>
